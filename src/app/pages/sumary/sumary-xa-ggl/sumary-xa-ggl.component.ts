...
@Component({
  selector: 'app-sumary-xa-ggl',
  templateUrl: './sumary-xa-ggl.component.html',
  styles: [
  ]
})
export class SumaryXaGglComponent implements OnInit {
  ...
  cargarDatos(){
    this.cargando=true;
    this.summary.cargarGgl(this.desde).subscribe(
      ({total,precios})=>{
        console.log(precios);
