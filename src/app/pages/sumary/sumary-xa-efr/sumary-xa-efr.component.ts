...
@Component({
  selector: 'app-sumary-xa-efr',
  templateUrl: './sumary-xa-efr.component.html',
  styles: [
  ]
})
export class SumaryXaEfrComponent implements OnInit {
  ...
  cargarDatos(){
    this.cargando=true;
    this.summary.cargarEfr(this.desde).subscribe(
      ({total,precios})=>{
        console.log(precios);
