...
@Component({
  selector: 'app-sumary-xa-lrc',
  templateUrl: './sumary-xa-lrc.component.html',
  styles: [
  ]
})
export class SumaryXaLrcComponent implements OnInit {
  ...
  cargarDatos(){
    this.cargando=true;
    this.summary.cargarLrc(this.desde).subscribe(
      ({total,precios})=>{
        console.log(precios);
