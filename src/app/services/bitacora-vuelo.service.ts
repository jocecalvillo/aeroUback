...
import { CargarBitacoraVueloGral } from '../models/bitacorasVuelo/bitacoraVueloGral.models';
...
export class BitacoraVueloService {
  ...
  cargarBitVuelo2(desde:number=0,vuelo:string){
    const url=`${base_url}/bitacoraVuelo/${vuelo}?desde=${desde}`;
    return this.http.get<CargarBitacoraVueloGral>(url,this.headers);
  }
