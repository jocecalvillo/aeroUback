...
import { CargaPrecioAterrizajeMex, PrecioAterrizajeMex, PrecioAterrizajeMexForm } from '../models/precioAterrizajeMex.models';
...
crearPrecios(precio :PrecioAterrizajeMexForm) {
